...
const routes = [
    {
        ...
        children: [
            ...
            { path: 'mcp-servers', name: 'mcp-servers', component: () => import('@/pages/McpServersPage.vue') },
            { path: 'objectives/:id/swarm', name: 'swarm-detail', component: () => import('@/pages/SwarmDetailPage.vue') },
